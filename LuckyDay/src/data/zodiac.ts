...
export function generateDailyFortune(zodiacId: string): DailyFortune {
  ...
  const summaries: Record<string, string[]> = {
    '火': ['今日充满活力，适合开展新计划', '热情高涨，人际关系顺利', '创意迸发，把握机会展现自我'],
    '土': ['稳扎稳打，今日适合处理细节工作', '脚踏实地，收获在望', '保持耐心，好事多磨'],
    '风': ['思维敏捷，适合学习交流', '社交活跃，结识新朋友', '灵感涌现，记录你的想法'],
    '水': ['直觉敏锐，相信内心的声音', '情感丰富，适合深度交流', '静水流深，享受独处时光']
  }

  const advices: Record<string, string[]> = {
    '火': ['保持热情但避免冲动', '分享你的能量给他人', '勇敢追求你的目标'],
    '土': ['适当放松，不要太过紧绷', '享受当下的美好', '相信积累的力量'],
    '风': ['多倾听他人的想法', '把创意付诸行动', '保持开放的心态'],
    '水': ['照顾好自己的情绪', '与信任的人分享感受', '给自己一些独处时间']
  }

  const zodiac = zodiacSigns.find(z => z.id === zodiacId)
  const element = zodiac?.element || '火'
